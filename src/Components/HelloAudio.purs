module Components.HelloAudio where
...
introRun e = runInElement' e introEx

introEx :: forall lock payload. Domable Effect lock payload
introEx = makePursx' (Proxy :: _ "@") px
  { ex1: nut
